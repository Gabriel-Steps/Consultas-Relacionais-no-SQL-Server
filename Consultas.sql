...
SELECT Ano, Count(id) AS Quantidade FROM Filmes GROUP BY Ano ORDER BY Ano DESC;

-- Tarefa 8: Buscar os Atores do gênero masculino, retornando o PrimeiroNome, UltimoNome
SELECT * FROM Atores WHERE Genero = 'M' GROUP BY id, PrimeiroNome, UltimoNome, Genero;

-- Tarefa 9: Buscar os Atores do gênero feminino, retornando o PrimeiroNome, UltimoNome, e ordenando pelo PrimeiroNome
SELECT * FROM Atores WHERE Genero = 'F' GROUP BY id, PrimeiroNome, UltimoNome, Genero ORDER BY PrimeiroNome ASC;
